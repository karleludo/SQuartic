...
// create admin account PROTOTYPE
// TODO: modularize
// description: The following block is used to create test account credentials for Admin login "/admin" page

const createUser = require(__dirname + "/modules/user-model/Admin.js")
  .createUser;
let admin = createUser("testAdminName", "testPassword"); // test account credentials
